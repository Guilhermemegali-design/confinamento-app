...
export function useDadosConfinamento(consultorId) {
  ...
  return {
    clientes, lotes, pesagens, consumos, saidas, leiturasCocho, cargasVagao, ingredientesMs, dietas, clientesUsuarios, currais, curralOcupacoes, recebimentosConsultoria, carregando,
