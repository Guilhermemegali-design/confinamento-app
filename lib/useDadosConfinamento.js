...
export function useDadosConfinamento(consultorId) {
  ...
  // sem curral (curral_id vira null via "on delete set null" no banco).
  ...
  return {
    clientes, lotes, pesagens, consumos, leiturasCocho, clientesUsuarios, currais, carregando,
    ...
    adicionarCurral, atualizarCurral, excluirCurral, importarCurraisEmLote,
