...
export function useDadosConfinamento(consultorId) {
  ...
  return {
    clientes, lotes, pesagens, consumos, saidas, leiturasCocho, cargasVagao, ingredientesMs, clientesUsuarios, currais, curralOcupacoes, recebimentosConsultoria, carregando,
