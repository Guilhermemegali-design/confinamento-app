...
## Relatório visual do trato — 17/09/2026

Integrado sobre `d0f366f` (produção atual), preservando as correções de consumo,
convite, mapas e leitura offline. A aba Cargas exporta PDF A4 horizontal por dia
...
Os cálculos estão em `lib/relatorioTrato.mjs`, a composição visual em
`lib/relatorioTratoPdf.mjs`. A resolução histórica de lote/curral é compartilhada
com as importações. O portal pagina o histórico com ordem estável e só libera a
